...
for source in time_of_day_order:
    for target in time_of_day_order:
        ...
        output_path = r"C:\Users\anasn\Desktop\E\Semester 4\Thesis\R code\xgboost timeseries\prediction plots xgboost\results_combination_rnn_gru_alone.xlsx"
