...
for source in time_of_day_order:
    for target in time_of_day_order:
        ...
        np.random.seed(SEED)
        shuffled_ids = np.random.permutation(participant_id)  # shuffle
        n = len(shuffled_ids)
        ...
        output_path = r"C:\Users\anasn\Desktop\E\Semester 4\Thesis\R code\xgboost timeseries\prediction plots xgboost\results_combination_lgbm_ema.xlsx"
